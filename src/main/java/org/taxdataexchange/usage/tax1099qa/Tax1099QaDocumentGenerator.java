package org.taxdataexchange.usage.tax1099qa;

import org.taxdataexchange.core.utils.*;
import org.taxdataexchange.docs.tax1099qa.models.*;
import org.taxdataexchange.docs.tax1099qa.utils.*;

public class Tax1099QaDocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1099Qa" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        Tax1099QaPdfBuilder pdfBuilder = new Tax1099QaPdfBuilder( );
        byte[] bytes = pdfBuilder.buildQr( taxDataList );

        String filePath = "samples/Tax1099Qa.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax1099Qa.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax1099Qa.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1099Qa.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1099Qa.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "Tax1099QaDocumentGenerator Begin" );
        ...
        System.out.println( "Tax1099QaDocumentGenerator Done" );
