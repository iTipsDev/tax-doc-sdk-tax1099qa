# tax-doc-sdk-tax1099qa

Software development kit to generate IRS Form 1099-QA as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099Qa.sample.png" width="850"/>
